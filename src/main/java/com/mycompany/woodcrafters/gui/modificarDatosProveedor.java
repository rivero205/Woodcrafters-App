...
public class modificarDatosProveedor extends javax.swing.JFrame {
    ...
    public modificarDatosProveedor(int id) {
        initComponents();
   ...
   private void limpiarCampos(javax.swing.JPanel panel) {
    ...
    private void btnGuardarjButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarjButton17ActionPerformed
        ...
        control.modificarProveedor(proveedor, nombre, direccion, telefono);
        
        
        mostrarMensaje("Edicion realizada correctamente", "Info", "Edición Correcta");
        
        verDatosProveedor pantalla = new verDatosProveedor();
    ...
    private void cargarDatos(int id) {
        this.proveedor = control.traerProveedor(id);
